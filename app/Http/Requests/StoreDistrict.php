...
class StoreDistrict extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'user_id.required'  => 'Debe asignar un Gerente al distrito',
            'zone_id.required'  => 'Debe asignar el distrito a una zona',
            'user_id.numeric'   => 'Debe asignar un Gerente al distrito',
            'zone_id.numeric'   => 'Debe asignar el distrito a una zona',
        ];
    }
}
